...
get_header(); ?>
	...
	<div class="slide slide2" id="slide2" data-slide="2" data-stellar-background-ratio="1">
	...
	<header id="branding" role="banner">
		<nav id="access" role="navigation">
			<ul class="navigation">
				...
				<li class="our-mission-nav" data-slide="2">Our Mission</li>
	...
	<div class="slide" id="slide5" data-slide="5" data-stellar-background-ratio="0">
		<section class="texture-with-border" data-stellar-ratio="1" data-stellar-vertical-offset="-600">
			<div class="top" id="testimonials"></div>
	...
	<div class="slide contact-hit" id="slide6" data-slide="6" data-stellar-background-ratio="0">
		<section class="wrapper-780">
